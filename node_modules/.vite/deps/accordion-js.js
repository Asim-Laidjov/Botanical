  ...
  "node_modules/accordion-js/dist/accordion.min.js"(exports, module) {
    !function(e) {
      var t = 0, n = function e2(n2, s) {
        ...
        if (Array.isArray(n2)) return !!n2.length && n2.map(function(t2) {
          return new e2(t2, s);
        });
        var a = { init: function() {
          ...
          if (t2 > this.elements.length - 1) return this.focusFirstElement(e3);
          this.focus(e3, this.elements[t2]), this.currFocusedIdx = t2;
        }, focusPrevElement: function(e3) {
          var t2 = this.currFocusedIdx - 1;
          if (t2 < 0) return this.focusLastElement(e3);
          this.focus(e3, this.elements[t2]), this.currFocusedIdx = t2;
          ...
          if (!i2 || s2) return i2 ? this.closeElement(e3) : this.showElement(e3);
